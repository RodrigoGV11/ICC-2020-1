...
public class SVG {
    ...
    public void agregarLinea(Linea linea) {
        // Implementar
        String l = "<line x1=\"" + linea.getP1().getX() + "\" y1=\"" + linea.getP1().getY() + "\" x2=\"" + linea.getP2().getX() + "\" y2=\"" + linea.getP2().getY() + "\" style= stroke: black; stroke-width: 1\"/>";
        concatenar(l);
    }
    ...
    public void agregarTriangulo(Triangulo triangulo) {
        // Implementar
        String t = "<line x1=\"" + triangulo.getA().getX() + "\" y1=\"" + triangulo.getA().getY() + "\" x2=\"" + triangulo.getB().getX() + "\" y2=\"" + triangulo.getB().getY() + "\" x3=\"" + triangulo.getC().getX() + "\" y3=\"" + triangulo.getC().getY() + "\" style= stroke: black; stroke-width: 1\"/>";
        concatenar(t);
    }
